...
import 'package:zip_peer/views/screens/listing_module/rental_listing.dart';
...
class _MyListedItemsScreenState extends State<MyListedItemsScreen> {
  ...
  final List<String> _tabs = ['Requests', 'Active Items', 'Past Rentals'];
  ...
  Widget _buildRequestsTab() {
    return ListView.builder(
      ...
      itemBuilder: (context, index) {
        ...
        return Bounce(
          onTap: () {
            Get.to(() => const ListingRentalScreen());
          },
          child: Container(
